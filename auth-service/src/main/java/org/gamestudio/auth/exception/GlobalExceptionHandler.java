package org.gamestudio.auth.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorDetails> handleAuthenticationServiceException(AuthenticationServiceException ex,
        ...
        return handleException(ex, webRequest, HttpStatus.FORBIDDEN, Map.of());
    }

    @ExceptionHandler(Exception.class)
    public ResponseEntity<ErrorDetails> handleOtherExceptions(Exception ex, WebRequest webRequest) {
        return handleException(ex, webRequest, HttpStatus.BAD_REQUEST, Map.of());
    }
